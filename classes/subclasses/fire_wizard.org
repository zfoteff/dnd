...
#+END_CENTER
-----
Even though they require an existing source of fire for the first few levels. Until the Pyromancer trait is learned (or the Cursed Fire spell), they will often have to expend a turn to light a fire or make sure a fire exists to be useful in combat.
...
- _/Pyromancer/_: Create fire from thin air and cast it to a combustable object. This fire will quickly extinguish if there is no fuel for it to consume.
* Level 1
...
- _*Flame Throw*_: Roll to hit. On a roll of over 11, throw an already existing flame (that you can see) from one location to another. The projectile is a ball with a 3-inch radius, and upon impact deals 1d10 fire damage to everyone within a two-foot radius. This requires the existence of a flame in the environment (size does not matter).
